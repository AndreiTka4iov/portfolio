    ...
    <header>
        <div className={cl.flexHeader}>
          ...
          <nav className={show ? cl.rightBtn + ' ' + cl.show : cl.rightBtn }>
            <HeaderButton style={{'--i': '1'}} href="/portfolio/#home">Home</HeaderButton>
            <HeaderButton style={{'--i': '2'}} href="/portfolio/#about">About</HeaderButton>
            <HeaderButton style={{'--i': '3'}} href="/portfolio/#skills">Skills</HeaderButton>
            <HeaderButton style={{'--i': '4'}} href="/portfolio/#works">Works</HeaderButton>
          </nav>
          {show 
